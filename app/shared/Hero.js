        ...
        <section className="text-zinc-400 bg-zinc-900 body-font">
            ...
            <div className="flex flex-col mb-16 items-center text-center md:items-start md:text-left md:mb-0 md:pr-16 md:w-1/2 lg:pr-24 lg:flex-grow">
                ...
                <p className="mb-8 leading-relaxed">
                    An Office worker with a bad case of insomnia teams up with a soap maker and insanity ensues.
                </p>
                <a href="https://imbd.com/title/tt0137523" className="text-white bg-orange-400 border-0 py-2 px-6 rounded-lg text-lg hover:bg-orange-500">Learn more</a>
