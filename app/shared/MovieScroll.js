   ...
   return(
       <section className="text-zinc-400">
           <div className="container px-5 py-12 mx-auto">
               <h1 className="capitalize font-medium title-font mb-4 text-zinc-50 text-xl">{genre}</h1>
                   ...
                   {movies.map(movie =>(
                       <div key={movie.id} className="p-4 sm:w-1/2 lg:w-1/3">
                           <div className="flex relative">
                               ...
                               <div className="px-8 py-10 relative z-10 w-full bg-zinc-900 border-zinc-400 border-4 opacity-0 hover:opacity-100 transition">
                                   <h4 className="tracking-widest text-sm title-font font-medium text-orange-400 mb-1">{genre}</h4>
                                   <h3 className="text-lg title-font font-medium text-zinc-50">{movie.title}</h3>
                               </div>
                           </div>
